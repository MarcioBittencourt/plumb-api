...
export class assessements1635192279131 implements MigrationInterface {
  name = 'assessements1635192279131';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "assessement" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying NOT NULL, "request_date" TIMESTAMP NOT NULL, "deadline_date" TIMESTAMP, "concluded_date" character varying, "status" character varying NOT NULL, "punctuation" integer, "evaluator_id" integer, "rated_id" integer, CONSTRAINT "PK_57062fb5679c85ce473d0719ce0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
